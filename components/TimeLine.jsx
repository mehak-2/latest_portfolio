  ...
  const data = [
    {
      ...
      duration: "Jul-2024",
      org: "Jagruti Rehabilitaton Center",
      skills: ["HTML", "CSS" , "NEXT JS", "TALWIND CSS"],
      class:
    ...
    },
    {
      ...
      duration: "Jul 2024",
      org: "Wow Diamond",
      skills: ["JavaScript", "React.js", "Node.js", "Firebase"],
      class:
    ...
    },
    {
      ...
      org: "The Good Game Theory",
      skills: ["React Js", "React Flow", "CSS", "JSON"],
      class:
    ...
    },
    {
      ...
      org: "GDSC IKGPTU",
      skills: ["Android", "Leadership", "Networking"],
      class:
    ...
    },
    {
      ...
      duration: "Aug 2022",
      org: "Bizarre Coders",
      skills: ["Coding club", "Community", "Networking"],
      class:
