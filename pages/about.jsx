...
import HeroBlack from "@/public/hero-black.jpeg";
import HeroWhite from "@/public/hero-white.jpeg";
      ...
      <main className="  max-w-screen ">
        <div className=" mx-auto pt-16 -pb-10 max-w-7xl">
          ...
          <div className=" text-[0.92rem] text-base mx-12 font-light dark:text-white text-gray-900">
            ...
            <p className="text-gray-800 select-none font-semibold mb-1 dark:text-white/50 text-xl">
              Contact
            </p>

            <p className="">
              <span className="text-red-700 font-bold">GMail: <br/></span>{" "}
              <a
                onClick={() =>
                  navigator.clipboard.writeText("kangmehak167@gmail.com")
                }
                ...
                href="kangmehak167@gmail.com"
              >
                {" "}
                kangmehak167@gmail.com
              </a>{" "}
              <br></br>
              <br></br><span className="text-blue-700 font-bold">LinkedIn</span>{" "}
              <a
                href="https://linkedin.com/in/mehak-45a190245"
...
<br></br>
              ...
              <span className="text-orange-500 font-bold">Github</span>{" "}
              <br></br>
              <a
